## Matrix inversion is usually a costly computation and it is beneficial to cache the inverse of a matrix rather than compute it repeatedly. The following functions achieve that.
